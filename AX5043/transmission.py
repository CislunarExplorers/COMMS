...
class AX5043():
	...
	def transmit(self, data):
		...
		reg = _ax5043.read_reg(Register.AX_REG_XTALSTATUS)
		usleep(10)
		while (reg != Register.AX_REG_XTALSTATUS_MASK):
			reg = _ax5043.read_reg(Register.AX_REG_XTALSTATUS)
			usleep(10)
		
		# Commit FIFO
		_ax5043.write_reg(Register.AX_REG_FIFOSTAT,0x04)
		...
		reg = _ax5043.read_reg(Register.AX_REG_RADIOSTATE)
		usleep(10)
		while (reg != 0x00):
			reg = _ax5043.read_reg(Register.AX_REG_RADIOSTATE)
			usleep(10)
	...
	def receive(self):
		...
		while (rstat != Register.AX_REG_RADIOSTATE_RX_MASK):
			rstat = _ax5043.read_reg(Register.AX_REG_RADIOSTATE)
		...
		fif0 = _ax5043.read_reg(Register.AX_REG_FIFOCOUNT0)
		fif1 = _ax5043.read_reg(Register.AX_REG_FIFOCOUNT1) 
	...
	def read_packets(self, FIFObytes):
		...
		for i in range(FIFObytes):
			reg = _ax5043.read_reg(Register.AX_REG_FIFODATA)	
			# print(reg)
			data += chr(reg)
		return data
